...
namespace POP_SF_63_2017_GUI.GUI
{
    ...
    public partial class NamestajCRUDWindow : Window
    {
        ...
        {
            if (e.Column.Header.ToString() == "Id" || e.Column.Header.ToString() == "AkcijaId" || e.Column.Header.ToString() == "TipNamestajaId" || e.Column.Header.ToString() == "Obrisan" || e.Column.Header.ToString() == "ProdataKolicina")
            {
                e.Cancel = true;
            }
        }
